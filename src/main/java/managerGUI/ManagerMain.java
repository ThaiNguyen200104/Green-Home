...
import adminGUI.PaymentLayout;
import adminGUI.RegisterLayout;
import adminGUI.ReportLayout;
...
public class ManagerMain extends JFrame {
	...
	private Mng_ManagerLayout managerLayout;
	private Mng_CustomerLayout customerLayout;
	...
	public ManagerMain() {
		...
		setResizable(false);
		setTitle("Green Home");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ManagerMain.class.getResource("/icons/jframeIcon.png")));
		...
		managerLayout = new Mng_ManagerLayout();
		...
		customerLayout = new Mng_CustomerLayout();
		...
		btnManager.setDisabledIcon(new ImageIcon(ManagerMain.class.getResource("/icons/disabled.png")));
		...
		btnManager.setIcon(new ImageIcon(ManagerMain.class.getResource("/icons/manager.png")));
		...
		btnCustomer.setDisabledIcon(new ImageIcon(ManagerMain.class.getResource("/icons/disabled.png")));
		...
		btnCustomer.setIcon(new ImageIcon(ManagerMain.class.getResource("/icons/customer.png")));
		...
		btnPayment.setDisabledIcon(new ImageIcon(ManagerMain.class.getResource("/icons/disabled.png")));
		...
		btnPayment.setIcon(new ImageIcon(ManagerMain.class.getResource("/icons/payment.png")));
		...
		btnReport.setDisabledIcon(new ImageIcon(ManagerMain.class.getResource("/icons/disabled.png")));
		...
		btnReport.setIcon(new ImageIcon(ManagerMain.class.getResource("/icons/report.png")));
		...
		btnRegister.setDisabledIcon(new ImageIcon(ManagerMain.class.getResource("/icons/disabled.png")));
		btnRegister.setIcon(new ImageIcon(ManagerMain.class.getResource("/icons/register.png")));
	...
	protected void btnManagerActionPerformed(ActionEvent e) {
	    ...
	    asList(btnCustomer, btnReport, btnRegister, btnPayment).forEach(button -> button.setForeground(new Color(255, 253, 231)));
	}
	...
	protected void btnCustomerActionPerformed(ActionEvent e) {
	    ...
	    ((JButton)e.getSource()).setForeground(new Color(156, 204, 101));
	    asList(btnManager, btnReport, btnRegister, btnPayment).forEach(button -> button.setForeground(new Color(255, 253, 231)));
	}
	...
	protected void btnReportActionPerformed(ActionEvent e) {
	    ...
	    ((JButton)e.getSource()).setForeground(new Color(156, 204, 101));
	    asList(btnManager, btnCustomer, btnRegister, btnPayment).forEach(button -> button.setForeground(new Color(255, 253, 231)));
	}
	...
	protected void btnRegisterActionPerformed(ActionEvent e) {
	    ...
	    ((JButton)e.getSource()).setForeground(new Color(156, 204, 101));
	    asList(btnManager, btnCustomer, btnReport, btnPayment).forEach(button -> button.setForeground(new Color(255, 253, 231)));
	}
	...
	protected void btnPaymentActionPerformed(ActionEvent e) {
	    ...
	    ((JButton)e.getSource()).setForeground(new Color(156, 204, 101));
	    asList(btnManager, btnCustomer, btnReport, btnRegister).forEach(button -> button.setForeground(new Color(255, 253, 231)));
	}
}
